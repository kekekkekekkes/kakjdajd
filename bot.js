...
client.on('ready',  () => {
  ...
  console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');const Discord = require('discord.js');
const client = new Discord.Client();
client.on('ready',  () => {
  console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'); 
...
client.user.setStatus("dnd");
 ...
 client.on('ready', () => {                           
client.user.setGame(`%help: BC System`,'https://www.twitch.tv/tarikrs');                                                                                                                                                                                                                                                                                                                                                                                                                             
});          
// playing
...
client.on("message", async message => {
    ...
    if (command == "leave") {
        ...
        if(message.author.id != "390412085378547714") return message.reply("**Sorry, you don't have permission to use this!**");
...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [`%help | BC System   |`,`By : KaNe `];
    var i = -1;
    var j = 0;
